...
RAG_PROMPT = ChatPromptTemplate.from_messages([
    ("system", "Bạn là trợ lý AI hữu ích. Chỉ dùng context sau để trả lời. Nếu không tìm thấy thông tin trong context, hãy nói 'Tôi không tìm thấy thông tin này trong tài liệu'.\n\nContext:\n{context}"),
    ("human", "{question}"),
])
